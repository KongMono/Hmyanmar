...
public class ListTVSocietyAdapter extends BaseAdapter {

	private LayoutInflater mInflater;
	private List<ListNewsEntry> items = new ArrayList<ListNewsEntry>();
	...
	public ListTVSocietyAdapter(Context context, ArrayList<ListNewsEntry> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ListNewsEntry item = items.get(position);
